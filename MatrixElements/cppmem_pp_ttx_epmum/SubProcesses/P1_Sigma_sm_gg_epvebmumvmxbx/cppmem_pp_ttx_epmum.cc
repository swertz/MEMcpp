...
cppmem_pp_ttx_epmum::cppmem_pp_ttx_epmum(Parameters_sm &params):
params(params)
{
  ...
  {
    {
      &cppmem_pp_ttx_epmum::matrix_1_gg_ttx_t_epveb_tx_mumvmxbx, 
      false, 
      {
        std::make_pair(21, 21)
      }
    ...
    , 
    {
      &cppmem_pp_ttx_epmum::matrix_1_uux_ttx_t_epveb_tx_mumvmxbx, 
      true, 
      {
...
std::map < std::pair < int, int > , double >
    cppmem_pp_ttx_epmum::sigmaKin(const std::vector < std::vector<double> >
...
void cppmem_pp_ttx_epmum::calculate_wavefunctions(const int perm[], const int
    hel[])
{
  ...
  FFV2_3(w[2], w[3], params.GC_100, params.mdl_MW, params.mdl_WW, w[5]); 
  FFV2_1(w[4], w[5], params.GC_100, params.mdl_MT, params.mdl_WT, w[6]); 
  ...
  FFV2_3(w[8], w[7], params.GC_100, params.mdl_MW, params.mdl_WW, w[10]); 
  FFV2_2(w[9], w[10], params.GC_100, params.mdl_MT, params.mdl_WT, w[11]); 
...
double cppmem_pp_ttx_epmum::matrix_1_gg_ttx_t_epveb_tx_mumvmxbx() 
{
...
double cppmem_pp_ttx_epmum::matrix_1_uux_ttx_t_epveb_tx_mumvmxbx() 
{
