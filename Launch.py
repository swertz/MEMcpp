...
while start_evt < max_evt:
	...
	LaunchOnCondor.SendCluster_Push(["BASH", os.path.join(path, "condor.sh"), os.path.join(path, "data/ttbar_weighted_noTF_isr0_pdfMtop_noMCoPerms_sobol_2000evt.root"), "ttbar_noTF_isr0_pdfMtop_noMCoPerms_as013_cuba_sobol_noSmooth_bugFix_" + str(i) + ".root", start_evt, end_evt])
